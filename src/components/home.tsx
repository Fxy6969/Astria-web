  ...
  return (
    <>
      ...
      <section className="relative mx-auto mt-32 max-w-[80rem] px-6 text-center md:px-8">
        <div
          className={cn("group rounded-full border max-w-[22rem] bg-navbar_bg")}
        >
          <TextShimmer className="backdrop-blur-xl inline-flex items-center justify-center px-4 py-1 transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400">
